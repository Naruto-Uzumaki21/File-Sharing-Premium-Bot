...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6578856529:AAGoP6WGkm-yA7F8edoWzl4cmrPbg-naesY")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002068536544"))
...
try:
    ADMINS=[7085541484]
    for x in (os.environ.get("ADMINS", "1768198143").split()):
        ADMINS.append(int(x))
except ValueError:
